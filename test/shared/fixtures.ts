...
import UniswapV3Pool from 'depin-dex-v3-core/artifacts/contracts/DepinDexPool.sol/DepinDexPool.json'
import UniswapV3FactoryJson from 'depin-dex-v3-core/artifacts/contracts/DepinDexFactory.sol/DepinDexFactory.json'
import NFTDescriptorJson from 'depin-dex-v3-periphery/artifacts/contracts/libraries/NFTDescriptor.sol/NFTDescriptor.json'
import NonfungiblePositionManagerJson from 'depin-dex-v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
import NonfungibleTokenPositionDescriptor from 'depin-dex-v3-periphery/artifacts/contracts/NonfungibleTokenPositionDescriptor.sol/NonfungibleTokenPositionDescriptor.json'
import SwapRouter from 'depin-dex-v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
